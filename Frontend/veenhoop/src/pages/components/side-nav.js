...
const SideNav = () => {
  ...
  return (
    <div className='h-[720px] bg-gradient-to-t from-lichtblauw to-donkerblauw w-52'>
      ...
      <button className="text-white h-16 text-lg transition duration-200 transform border top-[87%] absolute font-Rubik border-y-donkerblauw border-x-lichtblauw w-52 hover:scale-105 hover:bg-donkerblauw hover:text-white" onClick={handleLogout}>
        Uitloggen
      </button>
    </div>
  );

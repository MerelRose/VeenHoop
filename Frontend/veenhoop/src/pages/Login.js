  ...
  return (
    <>
      ...
      <div className="absolute left-[40%] top-[30%] bg-white p-5 h-[55%] rounded-lg">
        ...
        >
          <label htmlFor="email" className="text-lg font-Rubik">
            School e-mail:
          </label>
          <br />
          <input
          ...
          />
          <br />
          <cite className="text-gray-300">School e-mail</cite>
          <br />
          <label htmlFor="password" className="text-lg font-Rubik">
            Wachtwoord:
          </label>
          <br />
          <input
          ...
          />
          <br />
          <cite className="text-gray-300">Wachtwoord</cite>
          <br />
          {/* Buttons to switch API endpoint */}
          <div className="mb-4">
            <button
              type="button"
              className={`w-[185px] text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 ${
                apiEndpoint === 'http://localhost:3001/loginstudent' && 'bg-blue-800 text-white'
              }`}
            ...
            <button
              type="button"
              className={`w-[185px] text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 ${
                apiEndpoint === 'http://localhost:3001/logindocent' && 'bg-blue-800 text-white'
              }`}
